        ...
        <section class="choose ">
            <div class="arrival-images row justify-content-center align-items-start text-center mt5">
                <div class="arrival-image col-12 mb-4 mb-sm-0 mb-md-4 mb-lg-0 col-sm-12 col-md-6 col-lg-4" data-aos="fade-up">
                    <img src="assets/images/mobildua.png" alt="pict1" width="566px" class="img-fluid">
                </div>
                <div class=" text-sm-start col-12 mb-4 mb-sm-0 mb-md-4 mb-lg-0 col-sm-12 col-md-6 col-lg-4" data-aos="fade-up">

                    <h1 class="text-sm-start ">New Carry Pick-Up</h1>
                    <p class="text-sm-start ">
                        <li>Dimensi: Suzuki New Carry Pick-Up memiliki dimensi kompak yang cocok untuk kebutuhan komersial. Dimensi umumnya dapat berbeda tergantung pada model dan konfigurasi yang tersedia di wilayah Anda.
                        </li>
                        <li>Kapasitas Muatan: Truk pikap ini dirancang untuk dapat mengangkut beban berat. Kapasitas muatan Carry Pick-Up bervariasi tergantung pada versi dan konfigurasi yang dipilih, dan dapat mencapai beberapa ratus kilogram.
                        </li>
                        <li>Mesin: Carry Pick-Up dilengkapi dengan mesin bensin yang efisien. Mesin yang digunakan biasanya memiliki kapasitas sekitar 1.5 liter atau sesuai dengan spesifikasi regional.
                        </li>
                    </p>
                </div>
        </section>
                                    ...
                                    <div class="row" style=" justify-content:center;">
                                        <div class="">
                                            <div class="mb-20 aos-init aos-animate" data-aos="fade-up" data-offset="300">
                                                <div class="group-model">New Carry Pick-Up</div>
                                                <div class="sales-model">Flat-Deck PS</div>
                                                <div class="price">Rp<strong>164.500.000</strong></div>
                                            </div>
                                        </div>
