        ...
        <section class="choose ">
            <div class="arrival-images row justify-content-center align-items-start text-center mt5">
                <div class="arrival-image col-12 mb-4 mb-sm-0 mb-md-4 mb-lg-0 col-sm-12 col-md-6 col-lg-4" data-aos="fade-up">
                    ...
                    <img src="assets/images/sat.png" alt="pict1" class="img-fluid">

                </div>
                <div class=" text-sm-start col-12 mb-4 mb-sm-0 mb-md-4 mb-lg-0 col-sm-12 col-md-6 col-lg-4" data-aos="fade-up">

                    <h1 class="text-sm-start ">Suzuki Satria F150</h1>
                    <p class="text-sm-start ">
                        <li>Desain: Satria F150 memiliki tampilan yang agresif dan sporty. Desainnya didasarkan pada konsep aerodinamika untuk memberikan penampilan yang dinamis dan cepat.
                        </li>
                        <li>Mesin: Satria F150 ditenagai oleh mesin 4-langkah berkapasitas 147,3 cc. Mesin ini dilengkapi dengan teknologi injeksi bahan bakar (fuel injection)
                        </li>
                        <li>Performa: Motor ini memiliki tenaga yang cukup besar untuk kategori motor bebek. Dengan mesinnya, Satria F150 mampu menghasilkan daya maksimal sekitar 14,5 hp dan torsi maksimal sekitar 12,4 Nm.
                        </li>
                    </p>
                </div>
        </section>
                                    ...
                                    <div class="row" style=" justify-content:center;">
                                        <div class="">
                                            <div class="mb-20 aos-init aos-animate" data-aos="fade-up" data-offset="300">
                                                <div class="group-model">Satria</div>
                                                <div class="sales-model">F150</div>
                                                <div class="price">Rp<strong>30.000.000</strong></div>
                                            </div>
                                        </div>
