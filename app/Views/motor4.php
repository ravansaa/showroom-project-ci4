        ...
        <section class="choose ">
            <div class="arrival-images row justify-content-center align-items-start text-center mt5">
                <div class="arrival-image col-12 mb-4 mb-sm-0 mb-md-4 mb-lg-0 col-sm-12 col-md-6 col-lg-4" data-aos="fade-up">
                    ...
                    <img src="assets/images/ave.jpeg" alt="pict1" class="img-fluid">

                </div>
                <div class=" text-sm-start col-12 mb-4 mb-sm-0 mb-md-4 mb-lg-0 col-sm-12 col-md-6 col-lg-4" data-aos="fade-up">

                    <h1 class="text-sm-start ">Suzuki Avenis 125</h1>
                    <p class="text-sm-start ">
                        <li>Desain: Design Suzuki Avenis 125 mengadopsi garis-garis tajam pada bagian depan hingga bagian belakang yang ramping . Anda akan disuguhi tampilan desain yang membangkitkan rasa visual berkecepatan tinggi dan pengalaman yang mengasyikkan.

                        </li>
                        <li>Rasakan akselerasi yang mengesankan, pengalaman berkendara yang nyaman serta kemampuan bermanuver dalam melalui kepadatan lalu lintas dengan menggunakan Suzuki Avenis 125.
                        </li>
                        <li>Avenis 125 adalah pilihan terbaik untuk memenuhi kebutuhan masyarakat Indonesia dalam berkendara baik menjalankan tugas atau menikmati perjalanan yang mengasyikkan di sekitar kota.
                        </li>
                    </p>
                </div>
        </section>
                                    ...
                                    <div class="row" style=" justify-content:center;">
                                        <div class="">
                                            <div class="mb-20 aos-init aos-animate" data-aos="fade-up" data-offset="300">
                                                <div class="group-model">Avenis</div>
                                                <div class="sales-model">125</div>
                                                <div class="price">Rp<strong>31.000.000</strong></div>
                                            </div>
                                        </div>
