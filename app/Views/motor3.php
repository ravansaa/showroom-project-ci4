        ...
        <section class="choose ">
            <div class="arrival-images row justify-content-center align-items-start text-center mt5">
                <div class="arrival-image col-12 mb-4 mb-sm-0 mb-md-4 mb-lg-0 col-sm-12 col-md-6 col-lg-4" data-aos="fade-up">
                    ...
                    <img src="assets/images/pic1.jpeg" alt="pict1" class="img-fluid">

                </div>
                <div class=" text-sm-start col-12 mb-4 mb-sm-0 mb-md-4 mb-lg-0 col-sm-12 col-md-6 col-lg-4" data-aos="fade-up">

                    <h1 class="text-sm-start ">Suzuki Gixxer SF 250</h1>
                    <p class="text-sm-start ">
                        <li>Desain: Gixxer SF 250 memiliki tampilan yang sporty dan agresif dengan desain yang aerodinamis.
                        </li>
                        <li>Mesin: Gixxer SF 250 dilengkapi dengan mesin 4-langkah berkapasitas 249 cc. Mesin ini menggunakan teknologi pendinginan cairan (liquid-cooled) untuk menjaga suhu mesin agar tetap stabil.
                        </li>
                        <li>Performa: Mesin Gixxer SF 250 mampu menghasilkan tenaga yang tinggi. Daya maksimal yang dapat dicapai sekitar 26,5 hp, dengan torsi maksimal sekitar 22,2 Nm.
                        </li>
                    </p>
                </div>
        </section>
                                    ...
                                    <div class="row" style=" justify-content:center;">
                                        <div class="">
                                            <div class="mb-20 aos-init aos-animate" data-aos="fade-up" data-offset="300">
                                                <div class="group-model">Gixxer</div>
                                                <div class="sales-model">SF 250</div>
                                                <div class="price">Rp<strong>59.000.000</strong></div>
                                            </div>
                                        </div>
