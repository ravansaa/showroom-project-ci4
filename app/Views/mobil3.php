        ...
        <section class="choose ">
            <div class="arrival-images row justify-content-center align-items-start text-center mt5">
                <div class="arrival-image col-12 mb-4 mb-sm-0 mb-md-4 mb-lg-0 col-sm-12 col-md-6 col-lg-4" data-aos="fade-up">
                    ...
                    <img src="assets/images/mobiltiga.png" alt="pict1" width="566px" class="img-fluid">

                </div>
                <div class=" text-sm-start col-12 mb-4 mb-sm-0 mb-md-4 mb-lg-0 col-sm-12 col-md-6 col-lg-4" data-aos="fade-up">

                    <h1 class="text-sm-start ">Suzuki Baleno</h1>
                    <p class="text-sm-start ">
                        <li>Desain yang Menarik: Baleno memiliki desain yang modern dan aerodinamis. Dengan garis-garis yang tajam, gril yang mencolok, dan lampu depan yang menonjol, mobil ini memberikan tampilan yang segar dan menarik.
                        </li>
                        <li>Ruang dan Kenyamanan: Baleno menawarkan kabin yang lapang dan nyaman untuk penumpang di baris depan dan belakang. Ruang kaki dan ruang kepala yang memadai memberikan kenyamanan dalam perjalanan jarak jauh.
                        </li>
                        <li>Fitur-fitur Modern: Baleno dilengkapi dengan berbagai fitur modern, termasuk sistem infotainment yang terintegrasi, layar sentuh, konektivitas Bluetooth, sistem audio berkualitas tinggi, dan dukungan untuk Android Auto dan Apple CarPlay. Fitur-fitur ini memungkinkan pengendara untuk terhubung dengan mudah dengan smartphone mereka dan menikmati pengalaman hiburan yang lebih baik di dalam mobil.
                        </li>
                    </p>
                </div>
        </section>
                                    ...
                                    <div class="row" style=" justify-content:center;">
                                        <div class="">
                                            <div class="mb-20 aos-init aos-animate" data-aos="fade-up" data-offset="300">
                                                <div class="group-model">Suzuki</div>
                                                <div class="sales-model">Baleno</div>
                                                <div class="price">Rp<strong>265.500.000</strong></div>
                                            </div>
                                        </div>
