        ...
        <section class="choose ">
            <div class="arrival-images row justify-content-center align-items-start text-center mt5">
                <div class="arrival-image col-12 mb-4 mb-sm-0 mb-md-4 mb-lg-0 col-sm-12 col-md-6 col-lg-4" data-aos="fade-up">
                    ...
                    <img src="assets/images/mobilsatu.png" alt="pict1" width="566px" class="img-fluid">

                </div>
                <div class=" text-sm-start col-12 mb-4 mb-sm-0 mb-md-4 mb-lg-0 col-sm-12 col-md-6 col-lg-4" data-aos="fade-up">

                    <h1 class="text-sm-start ">Suzuki New XL7 Hybrid</h1>
                    <p class="text-sm-start ">
                        <li>Desain: Suzuki XL7 Hybrid memiliki desain eksterior yang modern dan sporty dengan gaya SUV yang tangguh. Desain interior juga dirancang dengan kenyamanan dan kepraktisan pengguna sebagai pertimbangan utama.
                        </li>
                        <li>Mesin: XL7 Hybrid dilengkapi dengan sistem hibrida yang terdiri dari mesin bensin dan motor listrik. Mesin bensin yang digunakan adalah mesin bensin 4 silinder dengan kapasitas mesin sekitar 1.5 liter.
                        </li>
                        <li>Transmisi: Mobil ini dilengkapi dengan transmisi otomatis berkecepatan variabel (CVT).
                        </li>
                    </p>
                </div>
        </section>
                                    ...
                                    <div class="row" style=" justify-content:center;">
                                        <div class="">
                                            <div class="mb-20 aos-init aos-animate" data-aos="fade-up" data-offset="300">
                                                <div class="group-model">Suzuki New XL7 Hybrid</div>
                                                <div class="sales-model">ZETA MT</div>
                                                <div class="price">Rp<strong>256.100.000</strong></div>
                                            </div>
                                        </div>
