        ...
        <section class="choose ">
            <div class="arrival-images row justify-content-center align-items-start text-center mt5">
                <div class="arrival-image col-12 mb-4 mb-sm-0 mb-md-4 mb-lg-0 col-sm-12 col-md-6 col-lg-4" data-aos="fade-up">
                    ...
                    <img src="assets/images/motordeskripsi.png" alt="pict1" class="img-fluid">

                </div>
                <div class=" text-sm-start col-12 mb-4 mb-sm-0 mb-md-4 mb-lg-0 col-sm-12 col-md-6 col-lg-4" data-aos="fade-up">

                    <h1 class="text-sm-start ">Suzuki GSX R150</h1>
                    <p class="text-sm-start ">
                        <li>Desain: GSX R150 memiliki desain yang agresif dan sporty. Motor ini menampilkan bodi full fairing yang aerodinamis, memberikan tampilan yang agung dan agresif di jalan.
                        </li>
                        <li>Mesin: Motor ini ditenagai oleh mesin 249 cc, pendingin cair, berkonfigurasi satu silinder. Mesin ini dilengkapi dengan teknologi Suzuki Oil Cooling System (SOCS) yang membantu menjaga suhu mesin tetap optimal.
                        </li>
                        <li>Performa: GSX R150 menawarkan performa yang mengesankan. Mesinnya mampu menghasilkan tenaga maksimum sekitar 26,5 PS (19,6 kW) pada 9.300 rpm dan torsi puncak sekitar 22,2 Nm pada 7.300 rpm. Dengan kombinasi tersebut, motor ini memberikan akselerasi yang cepat dan responsif.
                        </li>
                    </p>
                </div>
        </section>
                                    ...
                                    <div class="row" style=" justify-content:center;">
                                        <div class="">
                                            <div class="mb-20 aos-init aos-animate" data-aos="fade-up" data-offset="300">
                                                <div class="group-model">GSX</div>
                                                <div class="sales-model">R150</div>
                                                <div class="price">Rp<strong>38.000.000</strong></div>
                                            </div>
                                        </div>
